...
export default function WhatsAppButton() {
  ...
  return (
    <>
      <div id="whatsapp-button" className="fixed bottom-6 right-6 z-[9999]">
      <a
        href={whatsappUrl}
        target="_blank"
      ...
      >
        ...
        <span
          className={`font-semibold text-[15px] whitespace-nowrap overflow-hidden transition-all duration-300 ease-in-out ${isHovered ? 'w-24 opacity-100 pr-2 ml-1' : 'w-0 opacity-0 ml-0'}`}
        >
          Chat with us
        </span>
      </a>
