        ...
        <div className="flex flex-col lg:flex-row gap-4 lg:gap-24 items-center lg:items-start">
          ...
          <div className="w-full lg:w-[48%] flex flex-col space-y-6">
            <div className="relative w-full aspect-4/3 rounded-3xl overflow-hidden">
              <Image
                src="/About US.webp"
                alt="TrendwaveTech team at work, Gurugram"
                fill
                ...
                <div className="flex flex-row items-start gap-3">
                  ...
                  <div className="flex flex-col">
                    <p className="text-left w-full">
                      At TrendwaveTech (Trendwave Technologies / Trendwave Tech), we combine deep technical expertise with real execution capability to deliver technology solutions that solve operational challenges, improve efficiency, and strengthen digital security.
                    </p>
                  </div>
                </div>
